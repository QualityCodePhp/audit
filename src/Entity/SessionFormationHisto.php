...
/**
 * SessionFormationHisto
 *
 * @ORM\Table(name="session_formation_histo", uniqueConstraints={@ORM\UniqueConstraint(name="session_formation_histo_pk", columns={"seshis_id"})}, indexes={@ORM\Index(name="seshis_sess_fk", columns={"sess_id"}), @ORM\Index(name="adr_seshis_fk", columns={"adr_id"}), @ORM\Index(name="seshis_uti_cree_par_fk", columns={"uti_id_creat"}), @ORM\Index(name="seshis_air_fk", columns={"air_id"}), @ORM\Index(name="seshis_nature_agrement_fk", columns={"ref_id_nature_agrement"}), @ORM\Index(name="seshis_etat_recrutement_fk", columns={"ref_id_etat_recrutement"}), @ORM\Index(name="seshis_ofmou_fk", columns={"ofmou_id"}), @ORM\Index(name="seshis_ets_formateur_fk", columns={"ets_id_form"}), @ORM\Index(name="seshis_ref_type_session_fk", columns={"ref_id_type_session"}), @ORM\Index(name="seshis_antenne_fk", columns={"ant_id_form"}), @ORM\Index(name="seshis_ref_type_entree_fk", columns={"ref_id_type_entree"})})
 * @ORM\Entity
 */
class SessionFormationHisto
{
    /**
     * @var string
     *
     * @ORM\Column(name="seshis_id", type="decimal", precision=6, scale=0, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="SEQUENCE")
     * @ORM\SequenceGenerator(sequenceName="session_formation_histo_seshis_id_seq", allocationSize=1, initialValue=1)
     */
    private $seshisId;
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_deb", type="datetime", nullable=true)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_fin", type="datetime", nullable=true)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_info_co", type="datetime", nullable=true)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_debut_presc", type="datetime", nullable=true)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_fin_presc", type="datetime", nullable=true)
     */
     ...
     * @var string|null
     *
     * @ORM\Column(name="seshis_avis_niv1", type="decimal", precision=8, scale=0, nullable=true)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_entree_tardive", type="datetime", nullable=true)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_info_collective", type="datetime", nullable=true)
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="seshis_date_debut_envoi_carif", type="datetime", nullable=true)
     */
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="uti_id_creat", referencedColumnName="uti_id")
     * })
     */
    private $utiIdCreat;

    public function getSeshisId(): ?string
    {
        return $this->seshisId;
    }
    ...
    public function getSeshisAvisNiv1(): ?string
    {
        return $this->seshisAvisNiv1;
    }

    public function setSeshisAvisNiv1(?string $seshisAvisNiv1): self
    {
    ...
    public function getUtiIdCreat(): ?Utilisateur
    {
        return $this->utiIdCreat;
    }

    public function setUtiIdCreat(?Utilisateur $utiIdCreat): self
    {
        $this->utiIdCreat = $utiIdCreat;
